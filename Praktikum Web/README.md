...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>Demo : DBeaver installation & DB connection</td><td>2 :heavy_check_mark:</td>
        </tr>
        <tr>
            <td>Demo : MobaXterm installation & SSH connection</td><td>2 :heavy_check_mark:</td>
        </tr>
        <tr>
            <td>Demo : NodeJS & NPM installation, operation & hello world</td><td>4 :heavy_check_mark:</td>
        </tr>
        <tr>
            <td>Demo : Linux server operation</td><td>5 :heavy_check_mark:</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Demo : Domain registration</td><td>1 :heavy_check_mark:</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Demo : HTML Responsive Layout with Media Query & Flexbox</td><td>3 :heavy_check_mark:</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Demo : Browser API - Event Handling, Local Storage, Element manipulation</td><td>5 :heavy_check_mark:</td>
        </tr>
        <tr>
            <td>Demo : HTTP GET & POST using Form Action and Fetch API</td><td>5 :heavy_check_mark:</td>
        </tr>    
        <tr>
        ...
        <tr>
            <td>Demo : HTML Responsive Layout with Bootstrap</td><td>3 :heavy_check_mark:</td>
        </tr>
        <tr>
            <td>Demo : Single Page App with React & React-router</td><td>12 :heavy_check_mark:</td>
        </tr>
        <tr>
